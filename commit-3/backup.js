...
app.get('/rotinas', async (req, res) => {
    try {
        ...
        // Divida as linhas do arquivo em um array corretamente usando \n
...
app.post('/gravar', express.text(), async (req, res) => {
    ...
    console.log("Teste"); // Imprime o ID fornecido
    try {
        console.log("ID fornecido:", novaRotina.split(';')[0]); // Imprime o ID fornecido
        const data = await fs.readFile('rotinas.txt', 'utf-8');
        ...
        const indiceRotinaExistente = linhas.findIndex(linha => {
            ...
            console.log("ID novo:", idNovaRotina); // Imprime o ID fornecido
